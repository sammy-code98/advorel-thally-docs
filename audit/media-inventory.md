# Documentation media inventory

This internal inventory records the five photographs supplied and named by the project owner for the documentation. The filenames confirm the featured contributor and known event context. Photographer credits remain unconfirmed.

| Source file | Visible content | Event/context | Photographer/source | Permission | Proposed alt text | Proposed use |
| --- | --- | --- | --- | --- | --- | --- |
...
The documentation uses small product marks only to identify and link to the relevant tools. These marks remain the property of their respective owners and do not imply sponsorship or endorsement.

| Local asset | Official source | Usage note |
| --- | --- | --- |
| `public/images/tools/claude.ico` | [Claude](https://claude.ai/) | Product identification and link |
| `public/images/tools/canva.ico` | [Canva](https://www.canva.com/) | Product identification and link |
| `public/images/tools/github.ico` | [GitHub](https://github.com/) | Product identification and link |
| `public/images/tools/mintlify.ico` | [Mintlify](https://mintlify.com/) | Product identification and link |
| `public/images/tools/zencoder.png` | [Zencoder](https://zencoder.ai/) | Product identification and link |
| `public/images/tools/recall.ico` | [Recall](https://www.recall.ai/) | Product identification and link |
| `public/images/tools/docusaurus.png` | [Docusaurus](https://docusaurus.io/) | Product identification and link |
| `public/images/tools/mermaid.svg` | [Mermaid](https://mermaid.js.org/) | Product identification and link |
